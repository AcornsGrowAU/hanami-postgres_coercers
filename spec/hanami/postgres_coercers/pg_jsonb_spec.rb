...
describe Hanami::PostgresCoercers::PgJsonb do
  describe '.dump' do
    it 'dumps the value using Sequel' do
      value = double('value')
      expect(Sequel).to receive(:pg_jsonb).with(value)
  ...
  describe '.load' do
    ...
    context 'when the value is not nil' do
      context 'when the value is a jsonb hash' do
        it 'converts the value to a hash' do
          value = Sequel::Postgres::JSONBHash.new('')
      ...
      context 'when the value is a jsonb array' do
        it 'converts the value to an array' do
          value = Sequel::Postgres::JSONBArray.new('')
      ...
      context 'when the value is a jsonb op' do
        it 'gets the operator value' do
          value = Sequel::Postgres::JSONBOp.new('')
